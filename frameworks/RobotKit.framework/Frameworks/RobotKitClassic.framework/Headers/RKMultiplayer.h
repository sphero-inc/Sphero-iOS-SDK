...
typedef NS_ENUM(uint8_t, RKMultiplayerGameState) {
...
@property ( nonatomic, strong ) id <RKMultiplayerDelegateProtocol> delegate;
...
@property ( nonatomic, strong ) NSMutableArray *remotePlayers;

/*! The RKRemotePlayer object representing the local player.  Can also be found in remotePlayers array */
@property ( nonatomic, strong, readonly ) RKRemotePlayer *localPlayer;
