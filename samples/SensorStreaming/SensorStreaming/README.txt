...
SensorStreaming Sample Code
Platform: iOS
Version: 0.1
Copyright 2011 Orbotix, Inc.

Description:
This sample code demonstrates a basic app that will connect to a Sphero and show the streaming data from the Sphero on the screen of the iOS device.
