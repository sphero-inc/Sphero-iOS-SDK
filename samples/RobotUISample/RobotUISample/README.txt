...
Platform: iOS
Copyright 2011-2014 Orbotix, Inc.

Description:
This sample code demonstrates using several different standard and commonly used UI elements
including a joystick to drive Sphero, calibration gesture, color picker and sleep UI.
