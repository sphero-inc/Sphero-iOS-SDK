...
+ (instancetype)controlWithRobot:(RKRobotLE *)robot delegate:(id<RKOvalControlDelegate>)delegate;

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithRobot:(RKRobotLE *)robot delegate:(id<RKOvalControlDelegate>)delegate;
