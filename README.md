...
### Starting a new Project
  ...
  Please see the [1.6 release notes](https://github.com/orbotix/Sphero-iOS-SDK/blob/master/release%20notes/version1.6.md) for setting up a new project or follow the following Integrating with existing project section)
